...
254:('Reserved for Local Use','',''),
254:('Reserved for Local Use','',''),
192:('Particulate matter (coarse)','micro g m^-3','PMTC'),
193:('Particulate matter (fine)','micro g m^-3','PMTF'),
194:('Particulate matter (fine)','log10(micro g m^03','LPMTF'),
195:('Integrated column particulate matter (fine)','log10(micro g m^-3)','LIPMF'),
255:('Missing','','')}
...
254:('Reserved for Local Use','',''),
255:('Missing','','')}
codetable[2][3][1]={0:('Estimated Precipitation','kg m^-2','ESTP'),
...
4:('Estimated u-Component of Wind','m^-1','ESTUGRD'),
5:('Estimated v-Component of Wind','m^-1','ESTVGRD'),
...
14:("Minimum Dew Point depression","K","MINDPD"),
15:("Virtual Potential Temperature","K","VPTMP"),
16:("Snow phase change heat flux","Wm^-2","SNOHF"),
17:("Skin Temperature","K","SKINT"),
18:("Reserved","",""),
19:("Reserved","",""),
20:("Reserved","",""),
...
202:("Vertical Diffusion Heating rate","K/s","VDFHR"),
203:("Potential temperature at top of viscous sublayer","K","THZ0"),
204:("Tropical Cyclone Heat Potential","J/m^2K","TCHP"),
255:("Missing","","")},
1:{},2:{},3:{},4:{},5:{},6:{},7:{},13:{},14:{},15:{},18:{},19:{},190:{},191:{},192:{}},1:{},2:{},3:{},10:{}}
codetable[2][0][1]={0:("Specific Humidity","kg kg^-1","SPF_H"),
1:("Relative Humidity","%","R_H"),
...
14:("Convect Snow","kg m^-2","SNO_C"),
15:("Large-Scale Snow","kg m^-2","SNO_L"),
16:("Snow Melt","kg m^-2","SNO_M"),
17:("Snow Age","day","SNOAG"),
...
30:("Precipitable Water Category","See","PWCAT"),
31:("Hail","m","HAIL"),
32:("Grauple","kg kg^-1","GRLE"),
33:("Categorical Rain","Code table 4.222","CRAIN"),
34:("Categorical Freezing Rain","Code table 4.222","CFRZR"),
35:("Categorical Ice Pellets","Code table 4.222","CICEP"),
36:("Categorical Snow","Code table 4.222","CSNOW"),
37:("Convective Precipitation Rate","kg m^-2 s^-1","CPRAT"),
38:("Horizontal Moisture Divergence","kg kg^-1 s^-1","MCONV"),
39:("Percent frozen precipitation","%","CPOFP"),
...
52:("Total Precipitation Rate","kg m^-2s^-1","TPRATE"),
53:("Total Snowfall Rate Water Equivalent","kg m^-2s^-1","TSRWE"),
54:("Large Scale Precipitation Rate","kg m^-2s^-1","LSPRATE"),
55:("Convective Snowfall Rate Water Equivalent","kg m^-2s^-1","CSRWE"),
56:("Large Scale Snowfall Rate Water Equivalent","kg m^-2s^-1","LSSRWE"),
...
65:("Rain Precipitation Rate","kg m^-2s^-1","RPRATE"),
66:("Snow Precipitation Rate","kg m^-2s^-1","SPRATE"),
67:("Freezing Rain Precipitation Rate","kg m^-2s^-1","FPRATE"),
68:("Ice Pellets Precipitation Rate","kg m^-2s^-1","IPRATE"),
69:("Reserved","",""),
70:("Reserved","",""),
71:("Reserved","",""),
72:("Reserved","",""),
...
197:("Horizontal Moisture Divergence","kg kg^-1 s^-1","MCONV"),
198:("Minimum Relative Humidity","%","MINRH"),
...
2:("U-Component of Wind","m s^-1","U_GRD"),
3:("V-Component of Wind","m s^-1","V_GRD"),
4:("Stream Function","m^2 s^-1","STRM"),
5:("Velocity Potential","m^2 s^-1","V_POT"),
6:("Montgomery Stream Function","m^2 s^-1","MNTSF"),
7:("Sigma Coordinate Vertical Velocity","s^-1","SGCVV"),
8:("Vertical Velocity (Pressure)","Pa s^-1","V_VEL"),
9:("Vertical Velocity (Geometric)","m s^-1","DZDT"),
10:("Absolute Vorticity","s^-1","ABS_V"),
11:("Absolute Divergence","s^-1","ABS_D"),
12:("Relative Vorticity","s^-1","REL_V"),
13:("Relative Divergence","s^-1","REL_D"),
14:("Potential Vorticity","K m^2 kg^-1 s^-1","PVORT"),
15:("Vertical U-Component of Shear","s^-1","VUCSH"),
16:("Vertical V-Component of Shear","s^-1","VVCSH"),
17:("Momentum Flux, U-Component","N m^-2","U_FLX"),
18:("Momentum Flux, V-Component","N m^-2","V_FLX"),
19:("Wind Mixing Energy","J","WMIXE"),
20:("Boundary Layer Dissipation","W m^-2","BLYDP"),
21:("Maximum Wind Speed","m s^-1","MAXGUST"),
22:("Wind Speed (Gust)","m s^-1","GUST"),
23:("U-Component of Wind (Gust)","m s^-1","U_GUST"),
24:("V-Component of Wind (Gust)","m s^-1","V_GUST"),
25:("Vertical speed shear","s^-1","VW_SH"),
26:("Horizontal Momentum Flux","N m^-2","M_FLX"),
...
254:("Reserved for Local Use","",""),
254:("Reserved for Local Use","",""),
192:("Vertical speed shear","s^-1","VW_SH"),
193:("Horizontal Momentum Flux","N m^-2","M_FLX"),
...
218:("Velocity Point Model Surface","None","LMV"),
219:("Potential Vorticity (Mass-Weighted)","1/s/m","PVMWW"),
255:("Missing","","")}
codetable[2][0][3]={0:("Pressure","Pa","PRES"),
1:("Pressure Reduced to MSL","Pa","PRMSL"),
...
21:("Angle Of Sub-Grid Scale Orography","Rad","AOSGSO"),
22:("Slope Of Sub-Grid Scale Orography","Numeric","SSGSO"),
23:("Gravity Of Sub-Grid Scale Orography","W m^-2","GSGSO"),
24:("Anisotropy Of Sub-Grid Scale Orography","Numeric","ASGSO"),
25:("Reserved","",""),
26:("Reserved","",""),
27:("Reserved","",""),
...
210:("Mass Point Model Surface","None","LMH"),
211:("Geopotential Height (nearest grid point)","gpm","HGTN"),
212:("Pressure (nearest grid point)","Pa","PRESN"),
255:("Missing","None","")}
codetable[2][0][4]={0:("Net Short-Wave Radiation Flux (Surface)","W m^-2","NSWRS"),
1:("Net Short-Wave Radiation Flux (Top of Atmosphere)","W m^-2","NSWRT"),
2:("Short-Wave Radiation Flux","W m^-2","SWAVR"),
3:("Global Radiation Flux","W m^-2","G_RAD"),
4:("Brightness Temperature","K","BRTMP"),
5:("Radiance (with respect to wave number)","W m^-1 sr^-1","LWRAD"),
6:("Radiance (with respect to wavelength)","W m^-3 sr^-1","SWRAD"),
7:("Downward Short-Wave Rad. Flux","W m^-2","DSWRF"),
8:("Upward Short-Wave Rad. Flux","W m^-2","USWRF"),
...
254:("Reserved for Local Use","",""),
254:("Reserved for Local Use","",""),
192:("Downward Short-Wave Rad. Flux","W m^-2","DSWRF"),
193:("Upward Short-Wave Rad. Flux","W m^-2","USWRF"),
...
255:("Missing","","")}
codetable[2][0][5]={0:("Net Long-Wave Radiation Flux (Surface)","W m^-2","NLWRS"),
...
255:("Missing","None","")}
codetable[2][0][6]={0:("Cloud Ice","kg m^-2","C_ICE"),
1:("Total Cloud Cover","%","T_CDC"),
2:("Convective Cloud Cover","%","CDCON"),
3:("Low Cloud Cover","%","L_CDC"),
4:("Medium Cloud Cover","%","M_CDC"),
5:("High Cloud Cover","%","H_CDC"),
6:("Cloud Water","kg m^-2","C_WAT"),
7:("Cloud Amount","%","CDCA"),
8:("Cloud Type","See","CDCT"),
9:("Thunderstorm Maximum Tops","m","TMAXT"),
10:("Thunderstorm Coverage","See","THUNC"),
...
18:("Total Column-Integrated Cloud Water","kg m^-2","TCOLW"),
...
193:("Best (4 layer) Lifted Index","K","4LFTX"),
194:("Richardson Number","Numeric","RI"),
195:("Convective Weather Detection Index","None","CWDI"),
196:("Ultra Violet Index","J m^-2","UVI"),
197:("Updraft Helicity","m^2s^-2","UPHL"),
198:("Leaf Area Index","None","LAI"),
255:("Missing","","")}
codetable[2][0][13]={0:("Aerosol Type","See","AEROT"),
1:("Reserved","",""),
2:("Reserved","",""),
...
192:("Particulate matter (coarse)","&micro;g/m^3","PMTC"),
193:("Particulate matter (fine)","&micro;g/m^3","PMTF"),
194:("Particulate matter (fine)","log10(&micro;g/m^3)","LPMTF"),
195:("Integrated column particulate matter (fine)","log10(&micro;g/m^3)","LIPMF"),
255:("Missing","","")}
codetable[2][0][14]={0:("Total Ozone","Dobson","TOZNE"),
...
199:("Ozone production from col ozone term","kg/kg/s","POZO"),
255:("Missing","None","")}
codetable[2][0][15]={0:("Base Spectrum Width","m s^-1","BSWID"),
1:("Base Reflectivity","dB","BREF"),
2:("Base Radial Velocity","m s^-1","BRVEL"),
3:("Vertically Integrated Liquid (VIL)","kg m^-1","VERIL"),
4:("Layer Maximum Base Reflectivity","dB","LMAXBR"),
...
192:("Lightning","non-dim","LTNG"),
255:("Missing","","")}
codetable[2][0][18]={0:("Air Concentration of Cesium 137","Bq m^-3","ACCES"),
1:("Air Concentration of Iodine 131","Bq m^-3","ACIOD"),
2:("Air Concentration of Radioactive Pollutant","Bq m^-3","ACRADP"),
3:("Ground Deposition of Cesium 137","Bq m^-2","GDCES"),
4:("Ground Deposition of Iodine 131","Bq m^-2","GDIOD"),
5:("Ground Deposition of Radioactive Pollutant","Bq m^-2","GDRADP"),
6:("Time Integrated Air Concentration of Cesium Pollutant","Bq m^-3","TIACCP"),
7:("Time Integrated Air Concentration of Iodine Pollutant","Bq m^-3","TIACIP"),
8:("Time Integrated Air Concentration of Radioactive Pollutant","Bq m^-3","TIACRP"),
9:("Reserved","",""),
10:("Reserved","",""),
11:("Reserved","",""),
12:("Reserved","",""),
...
203:("Categorical Thunderstorm (1-yes, 0-no)","c","TSTMC"),
204:("Number of mixed layers next to surface","integer","MIXLY"),
205:("Flight Category","None","FLGHT"),
206:("Confidence - Ceiling","","CICEL"),
207:("Confidence - Visibility","","CIVIS"),
208:("Confidence - Flight Category","","CIFLT"),
209:("Low-Level aviation interest","","LAVNI"),
...
215:("Total Probability of Severe Thunderstorms (Days 2,3)","%","PRSVR"),
216:("Total Probability of Extreme Severe Thunderstorms (Days 2,3)","%","PRSIGSVR"),
217:("Supercooled Large Droplet (SLD) Potential","See","SIPD"),
218:("Radiative emissivity","","EPSR"),
219:("Turbulence Potential Forecast Index","None","TPFI"),
220:("Reserved","",""),
221:("Reserved","",""),
222:("Reserved","",""),
223:("Reserved","",""),
...
193:("East Longitude (0 - 360)","deg","ELON"),
194:("Seconds prior to initial reference time","s","TSEC"),
195:("Model Layer number (From bottom up)","None","MLYNO"),
196:("Latitude (nearest neighbor) (-90 to +90)","deg","NLATN"),
197:("East Longitude (nearest neighbor) (0 - 360)","deg","ELONN"),
255:("Missing","None","")}
codetable[2][0][192]={1:("Covariance between zonal and meridional components of the wind. Defined as [uv]-[u][v], where '[]' indicates the mean over the indicated time span.","m^2/s^2","COVZM"),
2:("Covariance between izonal component of the wind and temperature. Defined as [uT]-[u][T], where '[]' indicates the mean over the indicated time span.","K*m/s","COVTZ"),
3:("Covariance between meridional component of the wind and temperature. Defined as [vT]-[v][T], where '[]' indicates the mean over the indicated time span.","K*m/s","COVTM"),
4:("Covariance between temperature and vertical component of the wind. Defined as [wT]-[w][T], where '[]' indicates the mean over the indicated time span.","K*m/s","COVTW"),
...
11:("Covariance between surface pressure and surface pressure. Defined as [Psfc]-[Psfc][Psfc], where '[]' indicates the mean over the indicated time span.","Pa*Pa","COVPSPS"),
12:("Covariance between specific humidity and specific humidy. Defined as [qq]-[q][q], where '[]' indicates the mean over the indicated time span.","kg/kg*kg/kg","COVQQ"),
13:("Covariance between vertical and vertical components of the wind. Defined as [ww]-[w][w], where '[]' indicates the mean over the indicated time span.","Pa^2/s^2","COVVVVV"),
14:("Covariance between temperature and temperature. Defined as [TT]-[T][T], where '[]' indicates the mean over the indicated time span.","K*K","COVTT"),
255:("Missing","None","")}
codetable[2][1][0]={0:("Flash Flood Guidance","kg m^-2","FFLDG"),
...
255:("Missing","","")}
codetable[2][1][1]={0:("Conditional percent precipitation amount fractile for an overall period (encoded as an accumulation)","kg m^-2","CPPOP"),
1:("Percent Precipitation in a sub-period of an overall period (encoded as a percent accumulation over the sub-period)","%","PPOSP"),
2:("Probability of 0.01 inch of precipitation (POP)","%","POP"),
3:("Reserved","",""),
4:("Reserved","",""),
...
193:("Probability of Frozen Precipitation","%","CPOFP"),
194:("Probability of precipitation exceeding flash flood guidance values","%","PPFFG"),
195:("Probability of Wetting Rain, exceeding in 0.10 inches in a given time period","%","CWR"),
255:("Missing","","")}
codetable[2][2][0]={0:("Land Cover (1=land, 0=sea)","Proportion","LAND"),
1:("Surface Roughness","m","SFC_R"),
2:("Soil Temperature","K","TSOIL"),
3:("Soil Moisture Content","kg m^-2","SOIL_M"),
4:("Vegetation","%","VEG"),
...
25:("Volumetric Soil Moisture","m^3m^-3","VSOILM"),
26:("Wilting Point","kg m^-3","WILT"),
27:("Volumetric Wilting Moisture","m^3m^-3","VWILTM"),
28:("Reserved","",""),
29:("Reserved","",""),
30:("Reserved","",""),
31:("Reserved","",""),
...
204:("Humidity parameter in canopy conductance","Fraction","RCQ"),
205:("Soil moisture parameter in canopy conductance","Fraction","RCSOL"),
206:("Rate of water dropping from canopy to ground","None","RDRIP"),
207:("Ice-free water surface","%","ICWAT"),
208:("Surface exchange coefficients for T and Q divided by delta z","m/s","AKHS"),
209:("Surface exchange coefficients for U and V divided by delta z","m/s","AKMS"),
210:("Vegetation canopy temperature","K","VEGT"),
...
216:("Roughness length for heat","m","SFCRH"),
217:("Normalized Difference Vegetation Index","None","NDVI"),
218:("Land-sea coverage (nearest neighbor) [land=1,sea=0]","None","LANDN"),
219:("Asymptotic mixing length scale","m","AMIXL"),
...
8:("Direct Evaporation Cease (soil moisture)","Proportion","SMDRY"),
9:("Soil Porosity","Proportion","POROS"),
10:("Liquid Volumetric Soil Moisture (Non-Frozen)","m^3m^-3","LIQVSM"),
11:("Volumetric Transpiration Stree-Onset(Soil Moisture)","m^3m^-3","VOLTSO"),
12:("Transpiration Stree-Onset(Soil Moisture)","kg m^-3","TRANSO"),
13:("Volumetric Direct Evaporation Cease(Soil Moisture)","m^3m^-3","VOLDEC"),
14:("Direct Evaporation Cease(Soil Moisture)","kg m^-3","DIREC"),
15:("Soil Porosity","m^3m^-3","SOILP"),
16:("Volumetric Saturation Of Soil Moisture","m^3m^-3","VSOSM"),
17:("Saturation Of Soil Moisture","kgm^-3","SATOSM"),
18:("Reserved","",""),
19:("Reserved","",""),
20:("Reserved","",""),
21:("Reserved","",""),
...
255:("Missing","","")}
codetable[2][3][1]={0:("Estimated Precipitation","kg m^-2","ESTP"),
1:("Instantaneous Rain Rate","kg m^-2s^-1","IRRATE"),
2:("Cloud Top Height","m","CTOPH"),
3:("Cloud Top Height Quality Indicator","Code table 4.219","CTOPHQI"),
4:("Estimated u-Component of Wind","m^-1","ESTUGRD"),
5:("Estimated v-Component of Wind","m^-1","ESTVGRD"),
...
4:("U-Component of Ice Drift","m s^-1","U_ICE"),
5:("V-Component of Ice Drift","m s^-1","V_ICE"),
6:("Ice Growth Rate","m s^-1","ICE_G"),
7:("Ice Divergence","s^-1","ICE_D"),
9:("Ice Temperature","K","ICE_T"),
9:("Reserved","",""),
10:("Reserved","",""),
11:("Reserved","",""),
...
254:("Reserved for Local Use","",""),
255:("Missing","","")}
codetable[2][10][3]={0:("Ice Cover","Proportion","ICE_C"),
1:("Ice Thickness","m","ICETK"),
2:("Direction of Ice Drift","Degree True","DICED"),
3:("Speed of Ice Drift","m s^-1","SICED"),
4:("U-Component of Ice Drift","m s^-1","U_ICE"),
...
255:("Missing","","")}
codetable[2][10][191]={0:("Seconds Prior To Initial Reference Time (Defined In Section 1)","s","TSEC"),
1:("Reserved","",""),
2:("Reserved","",""),
3:("Reserved","",""),
4:("Reserved","",""),
